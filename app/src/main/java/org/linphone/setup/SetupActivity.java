...
public class SetupActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		firstFragment = getResources().getBoolean(R.bool.setup_use_linphone_as_first_fragment) ? SetupFragmentsEnum.LINPHONE_LOGIN : SetupFragmentsEnum.WELCOME;
	...
	public void onBackPressed() {
		...
		else if (currentFragment == SetupFragmentsEnum.GENERIC_LOGIN || currentFragment == SetupFragmentsEnum.LINPHONE_LOGIN || currentFragment == SetupFragmentsEnum.WIZARD || currentFragment == SetupFragmentsEnum.REMOTE_PROVISIONING) {
			MenuFragment fragment = new MenuFragment();
			changeFragment(fragment);
			currentFragment = SetupFragmentsEnum.MENU;
		}
	...
	public void saveCreatedAccount(String username, String password, String domain) {
		...
		if (isMainAccountLinphoneDotOrg && useLinphoneDotOrgCustomPorts) {
			...
			builder.setExpires("604800").setOutboundProxyEnabled(true);
