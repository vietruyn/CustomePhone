...
public class SettingsFragment extends PreferencesListFragment implements EcCalibrationListener {
	...
	private void initSettings() {
		...
		// add acction on setup wizard by Anh Duc
		findPreference("remove_all_sip_account").setOnPreferenceClickListener(new OnPreferenceClickListener() {
			@Override
			public boolean onPreferenceClick(Preference preference) {
				new AlertDialog.Builder(getActivity()).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Remove all SIP Account").setMessage("Do you want to remove all SIP account ???").setNegativeButton("Yes", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						// remove all account
						LinphoneManager.removeAllSIPAccount();
						// change layout
						LinphoneActivity.instance().displayAbout();
					}
